...
$social_instagram = get_option('sj_social_instagram', 'https://www.instagram.com/skillupjuniors/');
$social_youtube   = get_option('sj_social_youtube',   'https://www.youtube.com/@SkillUpJuniors');
$social_facebook  = get_option('sj_social_facebook',  'https://www.facebook.com/profile.php?id=61581372873657');
$social_whatsapp  = get_option('sj_social_whatsapp',  'https://wa.me/919160902424');
?>
            ...
            <div class="sj-footer__grid">
                ...
                <div class="sj-footer__brand">
                    ...
                    <div class="sj-footer__socials">
                        ...
                        <a href="<?php echo esc_url($social_facebook); ?>" class="sj-footer__social" aria-label="Facebook" target="_blank" rel="noopener">
                        ...
                        <a href="<?php echo esc_url($social_instagram); ?>" class="sj-footer__social" aria-label="Instagram" target="_blank" rel="noopener">
                        ...
                        <a href="<?php echo esc_url($social_youtube); ?>" class="sj-footer__social" aria-label="YouTube" target="_blank" rel="noopener">
                        ...
                        <a href="<?php echo esc_url($social_whatsapp); ?>" class="sj-footer__social" aria-label="WhatsApp" target="_blank" rel="noopener">
                    ...
                    <div class="sj-footer__powered">
                        ...
                        <div class="sj-footer__powered-logo">
                            <img
                                src="<?php echo get_template_directory_uri(); ?>/assets/images/thinkbuild-logo.png"
                ...
                <div class="sj-footer__col">
                    <h3 class="sj-footer__col-title"><span>Quick Links</span></h3>
                ...
                <!-- Col 3: Programs -->
                <div class="sj-footer__col">
                    <h3 class="sj-footer__col-title"><span>Our Programs</span></h3>
                    <ul class="sj-footer__links">
                        <li>
                            <svg width="6" height="10" viewBox="0 0 6 10" fill="none"><path d="M1 1l4 4-4 4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
                ...
                <!-- Col 4: Contact -->
                <div class="sj-footer__col">
                    <h3 class="sj-footer__col-title"><span>Get In Touch</span></h3>
