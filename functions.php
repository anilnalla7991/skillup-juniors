...
function sj_register_acf_fields() {
    ...
    acf_add_local_field_group([
        'key'    => 'group_vm_videos',
        'title'  => 'Vedic Maths — Demo Videos (10)',
        'fields' => [
            ...
            // Video 5
            ['key' => 'field_vm_vid5_title', 'label' => 'Video 5 — Title',            'name' => 'vm_video5_title', 'type' => 'text'],
            ['key' => 'field_vm_vid5_url',   'label' => 'Video 5 — YouTube URL',      'name' => 'vm_video5_url',   'type' => 'url'],
            ['key' => 'field_vm_vid5_thumb', 'label' => 'Video 5 — Thumbnail (opt.)', 'name' => 'vm_video5_thumb', 'type' => 'image', 'return_format' => 'array'],
            // Video 6
            ['key' => 'field_vm_vid6_title', 'label' => 'Video 6 — Title',            'name' => 'vm_video6_title', 'type' => 'text'],
            ['key' => 'field_vm_vid6_url',   'label' => 'Video 6 — YouTube URL',      'name' => 'vm_video6_url',   'type' => 'url'],
            ['key' => 'field_vm_vid6_thumb', 'label' => 'Video 6 — Thumbnail (opt.)', 'name' => 'vm_video6_thumb', 'type' => 'image', 'return_format' => 'array'],
            // Video 7
            ['key' => 'field_vm_vid7_title', 'label' => 'Video 7 — Title',            'name' => 'vm_video7_title', 'type' => 'text'],
            ['key' => 'field_vm_vid7_url',   'label' => 'Video 7 — YouTube URL',      'name' => 'vm_video7_url',   'type' => 'url'],
            ['key' => 'field_vm_vid7_thumb', 'label' => 'Video 7 — Thumbnail (opt.)', 'name' => 'vm_video7_thumb', 'type' => 'image', 'return_format' => 'array'],
            // Video 8
            ['key' => 'field_vm_vid8_title', 'label' => 'Video 8 — Title',            'name' => 'vm_video8_title', 'type' => 'text'],
            ['key' => 'field_vm_vid8_url',   'label' => 'Video 8 — YouTube URL',      'name' => 'vm_video8_url',   'type' => 'url'],
            ['key' => 'field_vm_vid8_thumb', 'label' => 'Video 8 — Thumbnail (opt.)', 'name' => 'vm_video8_thumb', 'type' => 'image', 'return_format' => 'array'],
            // Video 9
            ['key' => 'field_vm_vid9_title', 'label' => 'Video 9 — Title',            'name' => 'vm_video9_title', 'type' => 'text'],
            ['key' => 'field_vm_vid9_url',   'label' => 'Video 9 — YouTube URL',      'name' => 'vm_video9_url',   'type' => 'url'],
            ['key' => 'field_vm_vid9_thumb', 'label' => 'Video 9 — Thumbnail (opt.)', 'name' => 'vm_video9_thumb', 'type' => 'image', 'return_format' => 'array'],
            // Video 10
            ['key' => 'field_vm_vid10_title', 'label' => 'Video 10 — Title',            'name' => 'vm_video10_title', 'type' => 'text'],
            ['key' => 'field_vm_vid10_url',   'label' => 'Video 10 — YouTube URL',      'name' => 'vm_video10_url',   'type' => 'url'],
            ['key' => 'field_vm_vid10_thumb', 'label' => 'Video 10 — Thumbnail (opt.)', 'name' => 'vm_video10_thumb', 'type' => 'image', 'return_format' => 'array'],
        ],
        'location'   => $vm_page_location,
        'menu_order' => 50,
    ]);
    ...
    acf_add_local_field_group([
        ...
        'fields' => [
            ...
            ['key' => 'field_jne_form_btn_text', 'label' => 'Button Text', 'name' => 'jne_form_btn_text', 'type' => 'text', 'default_value' => 'Book My Free Trial Class'],
        ],
        'location'   => $jne_page_location,
        'menu_order' => 20,
    ]);
    ...
    acf_add_local_field_group([
        ...
        'fields' => [
            ...
            ['key' => 'field_sd_form_btn_text', 'label' => 'Button Text',            'name' => 'sd_form_btn_text',   'type' => 'text',     'default_value' => 'Book My Free Trial Class'],
        ],
        'location'   => $sd_page_location,
        'menu_order' => 15,
    ]);
    ...
    acf_add_local_field_group([
        ...
        'fields' => [
            ...
            ['key' => 'field_sd_curr_card1_pdf',   'label' => 'Card 1 — PDF File',     'name' => 'sd_curr_card1_pdf',     'type' => 'file', 'return_format' => 'url', 'mime_types' => 'pdf'],
            ...
            ['key' => 'field_sd_curr_card2_pdf',   'label' => 'Card 2 — PDF File',     'name' => 'sd_curr_card2_pdf',     'type' => 'file', 'return_format' => 'url', 'mime_types' => 'pdf'],
            ...
            ['key' => 'field_sd_curr_card3_pdf',   'label' => 'Card 3 — PDF File',     'name' => 'sd_curr_card3_pdf',     'type' => 'file', 'return_format' => 'url', 'mime_types' => 'pdf'],
            ...
            ['key' => 'field_sd_curr_card4_pdf',   'label' => 'Card 4 — PDF File',     'name' => 'sd_curr_card4_pdf',     'type' => 'file', 'return_format' => 'url', 'mime_types' => 'pdf'],
            ...
            ['key' => 'field_sd_curr_card5_pdf',   'label' => 'Card 5 — PDF File',     'name' => 'sd_curr_card5_pdf',     'type' => 'file', 'return_format' => 'url', 'mime_types' => 'pdf'],
        ],
        'location'   => $sd_page_location,
        'menu_order' => 40,
    ]);
    ...
    acf_add_local_field_group([
        'key'    => 'group_sd_videos',
        'title'  => 'Skill Dev — Demos / Kids Videos (10)',
        'fields' => [
            ...
            ['key' => 'field_sd_video4_url',    'label' => 'Video 4 — URL',     'name' => 'sd_video4_url',    'type' => 'url'],
            ['key' => 'field_sd_video4_title',  'label' => 'Video 4 — Title',   'name' => 'sd_video4_title',  'type' => 'text'],
            ['key' => 'field_sd_video5_url',    'label' => 'Video 5 — URL',     'name' => 'sd_video5_url',    'type' => 'url'],
            ['key' => 'field_sd_video5_title',  'label' => 'Video 5 — Title',   'name' => 'sd_video5_title',  'type' => 'text'],
            ['key' => 'field_sd_video6_url',    'label' => 'Video 6 — URL',     'name' => 'sd_video6_url',    'type' => 'url'],
            ['key' => 'field_sd_video6_title',  'label' => 'Video 6 — Title',   'name' => 'sd_video6_title',  'type' => 'text'],
            ['key' => 'field_sd_video7_url',    'label' => 'Video 7 — URL',     'name' => 'sd_video7_url',    'type' => 'url'],
            ['key' => 'field_sd_video7_title',  'label' => 'Video 7 — Title',   'name' => 'sd_video7_title',  'type' => 'text'],
            ['key' => 'field_sd_video8_url',    'label' => 'Video 8 — URL',     'name' => 'sd_video8_url',    'type' => 'url'],
            ['key' => 'field_sd_video8_title',  'label' => 'Video 8 — Title',   'name' => 'sd_video8_title',  'type' => 'text'],
            ['key' => 'field_sd_video9_url',    'label' => 'Video 9 — URL',     'name' => 'sd_video9_url',    'type' => 'url'],
            ['key' => 'field_sd_video9_title',  'label' => 'Video 9 — Title',   'name' => 'sd_video9_title',  'type' => 'text'],
            ['key' => 'field_sd_video10_url',   'label' => 'Video 10 — URL',    'name' => 'sd_video10_url',   'type' => 'url'],
            ['key' => 'field_sd_video10_title', 'label' => 'Video 10 — Title',  'name' => 'sd_video10_title', 'type' => 'text'],
        ],
        'location'   => $sd_page_location,
        'menu_order' => 70,
    ]);
    ...
    acf_add_local_field_group([
        'key'    => 'group_ph_form',
        'title'  => 'Phonics — Lead Form (Book a Demo)',
        'fields' => [
            ['key' => 'field_ph_form_heading',  'label' => 'Heading',      'name' => 'ph_form_heading',  'type' => 'text',    'default_value' => 'Book a <span>Free Demo Class</span> Today!'],
            ['key' => 'field_ph_form_sub',      'label' => 'Sub-text',     'name' => 'ph_form_sub',      'type' => 'textarea','rows' => 2, 'default_value' => 'Fill in your details and our expert Phonics trainer will contact you within 24 hours.'],
            ['key' => 'field_ph_form_perk1',    'label' => 'Perk 1',       'name' => 'ph_form_perk1',    'type' => 'text',    'default_value' => '100% Free — No Commitment'],
            ['key' => 'field_ph_form_perk2',    'label' => 'Perk 2',       'name' => 'ph_form_perk2',    'type' => 'text',    'default_value' => 'Live Online or In-Person'],
            ['key' => 'field_ph_form_perk3',    'label' => 'Perk 3',       'name' => 'ph_form_perk3',    'type' => 'text',    'default_value' => 'Certified Expert Trainers'],
            ['key' => 'field_ph_form_btn_text', 'label' => 'Button Text',  'name' => 'ph_form_btn_text', 'type' => 'text',    'default_value' => 'Book My Free Demo'],
        ],
        'location'   => $ph_page_location,
        'menu_order' => 15,
    ]);
    ...
    // Phonics: Demo Videos (10 slots)
    acf_add_local_field_group([
        'key'   => 'group_ph_videos',
        'title' => 'Phonics — Demo Videos (10)',
        'fields' => [
            ...
            ['key' => 'field_ph_video5_title', 'label' => 'Video 5 — Title',      'name' => 'ph_video5_title', 'type' => 'text'],
            ['key' => 'field_ph_video5_url',   'label' => 'Video 5 — YouTube URL', 'name' => 'ph_video5_url',   'type' => 'url'],
            ['key' => 'field_ph_video5_thumb', 'label' => 'Video 5 — Thumbnail',   'name' => 'ph_video5_thumb', 'type' => 'image', 'return_format' => 'array'],
            ['key' => 'field_ph_video6_title', 'label' => 'Video 6 — Title',      'name' => 'ph_video6_title', 'type' => 'text'],
            ['key' => 'field_ph_video6_url',   'label' => 'Video 6 — YouTube URL', 'name' => 'ph_video6_url',   'type' => 'url'],
            ['key' => 'field_ph_video6_thumb', 'label' => 'Video 6 — Thumbnail',   'name' => 'ph_video6_thumb', 'type' => 'image', 'return_format' => 'array'],
            ['key' => 'field_ph_video7_title', 'label' => 'Video 7 — Title',      'name' => 'ph_video7_title', 'type' => 'text'],
            ['key' => 'field_ph_video7_url',   'label' => 'Video 7 — YouTube URL', 'name' => 'ph_video7_url',   'type' => 'url'],
            ['key' => 'field_ph_video7_thumb', 'label' => 'Video 7 — Thumbnail',   'name' => 'ph_video7_thumb', 'type' => 'image', 'return_format' => 'array'],
            ['key' => 'field_ph_video8_title', 'label' => 'Video 8 — Title',      'name' => 'ph_video8_title', 'type' => 'text'],
            ['key' => 'field_ph_video8_url',   'label' => 'Video 8 — YouTube URL', 'name' => 'ph_video8_url',   'type' => 'url'],
            ['key' => 'field_ph_video8_thumb', 'label' => 'Video 8 — Thumbnail',   'name' => 'ph_video8_thumb', 'type' => 'image', 'return_format' => 'array'],
            ['key' => 'field_ph_video9_title', 'label' => 'Video 9 — Title',      'name' => 'ph_video9_title', 'type' => 'text'],
            ['key' => 'field_ph_video9_url',   'label' => 'Video 9 — YouTube URL', 'name' => 'ph_video9_url',   'type' => 'url'],
            ['key' => 'field_ph_video9_thumb', 'label' => 'Video 9 — Thumbnail',   'name' => 'ph_video9_thumb', 'type' => 'image', 'return_format' => 'array'],
            ['key' => 'field_ph_video10_title', 'label' => 'Video 10 — Title',      'name' => 'ph_video10_title', 'type' => 'text'],
            ['key' => 'field_ph_video10_url',   'label' => 'Video 10 — YouTube URL', 'name' => 'ph_video10_url',   'type' => 'url'],
            ['key' => 'field_ph_video10_thumb', 'label' => 'Video 10 — Thumbnail',   'name' => 'ph_video10_thumb', 'type' => 'image', 'return_format' => 'array'],
        ],
        'location'   => $ph_page_location,
        'menu_order' => 50,
    ]);
