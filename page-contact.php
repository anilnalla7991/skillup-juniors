...
// ── Social Links ───────────────────────────────────────────────────────────
$ct_facebook  = get_option('sj_social_facebook',  'https://www.facebook.com/profile.php?id=61581372873657');
$ct_instagram = get_option('sj_social_instagram', 'https://www.instagram.com/skillupjuniors/');
$ct_youtube   = get_option('sj_social_youtube',   'https://www.youtube.com/@SkillUpJuniors');
$ct_whatsapp_social = get_option('sj_social_whatsapp', 'https://wa.me/919160902424');
                ...
                <aside class="ct-info">
                    ...
                    <div class="ct-social">
                        ...
                        <div class="ct-social__links">
                            ...
                            <?php endif; ?>
                            <?php if ($ct_whatsapp_social) : ?>
                                <a href="<?php echo esc_url($ct_whatsapp_social); ?>" class="ct-social__link" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">
